    ...
    return(
      <div>
        <Label style={{width: '100%', borderRadius: '5px 5px 0 0'}} size='huge' color='blue'>
          Add New Quote
          <Button style={{float:'right'}} size='tiny' name='quoteOpen' color='grey' compact inverted onClick={(e) => this.props.close(e)}>
            X
          </Button>
        </Label>
        ...
        <Form success={this.state.submitSuccess} error={this.state.submitFailure}>
          ...
          <Button type='button' name='quotes' primary onClick={(e) => this.handleSubmit(e, this.state)}>Submit</Button>
          ...
          <Message success>
            <Message.Header>
              Success
              <Button style={{float:'right'}} size='medium' name='quoteOpen' color='green' onClick={(e) => this.props.close(e)}>
                Close Form
              </Button>
            </Message.Header>
            <Message.Content>
          ...
          <Message error>
            <Message.Header>
              Failure, quote was not saved.
              <Button style={{float:'right'}} size='medium' name='quoteOpen' color='red' onClick={(e) => this.props.close(e)}>
