...
class PoInputForm extends Component {
  constructor(props) {
    super(props);
    ...
    return(
      <div>
        <Label style={{width: '100%', borderRadius: '5px 5px 0 0'}} size='huge' color='blue'>
          Add New PO
          <Button style={{float:'right'}} size='tiny' name='poOpen' color='grey' compact inverted onClick={(e) => this.props.close(e)}>
            X
          </Button>
        </Label>
        ...
        <Form success={this.state.submitSuccess} error={this.state.submitFailure}>
          ...
          <Button type='button' name='pos' primary onClick={(e) => this.handleSubmit(e, this.state)}>Submit</Button>
          ...
          <Message success>
            <Message.Header>
              Success
              <Button style={{float:'right'}} size='medium' name='poOpen' color='green' onClick={(e) => this.props.close(e)}>
                Close Form
              </Button>
            </Message.Header>
            <Message.Content>
              This PO has been saved.
            </Message.Content>
          </Message>

          <Message error>
            <Message.Header>
              Failure, PO was not saved.
              <Button style={{float:'right'}} size='medium' name='poOpen' color='red' onClick={(e) => this.props.close(e)}>
